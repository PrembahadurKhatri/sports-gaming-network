...
/>
      ...
      <form onSubmit={handleLogin} className="relative w-full max-w-md rounded-2xl border bg-card/80 backdrop-blur-xl p-8 shadow-2xl dark:border-white/10 animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="text-center">
          <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br bg-gradient-to-r from-violet-900 to-indigo-700  shadow-lg shadow-violet-500/20">
            <span className="text-2xl font-bold text-white">SPN</span>
          </div>
        ...
        <div className="mt-4 flex items-center justify-between text-sm">
          ...
          <a href="#" className="text-violet-900 hover:text-violet-500 dark:text-violet-500 transition-colors">Forgot Password?</a>
        </div>

        <button
          type="submit" disabled={loading}
          className="mt-6 w-full rounded-lg bg-gradient-to-r from-violet-900 to-indigo-700 py-2.5 font-semibold text-white transition-all hover:opacity-90 hover:shadow-lg hover:shadow-violet-400/20 disabled:opacity-50 flex items-center justify-center gap-2"
        >
